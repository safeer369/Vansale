...
class SalesBillRvAdapter(private val list: ArrayList<ProductModel>) : RecyclerView.Adapter<SalesBillRvAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.item_rv_sales_bill, parent, false)
        return ViewHolder(v)
    }
