 ...
 */
class SalesOrderVpAdapter(fm: FragmentManager, private val list: ArrayList<SalesOrderInvoiceModel>) : FragmentPagerAdapter(fm) {
    var currentFragment: SalesOrderFragment? = null
    ...
    override fun setPrimaryItem(container: ViewGroup, position: Int, `object`: Any) {
        if (currentFragment != `object`) {
            currentFragment = `object` as SalesOrderFragment
        }
