...
import com.teamayka.vansaleandmgmt.ui.filedforce.adapters.RvCompletedListAdapter
...
class CompletedActivity : AppCompatActivity() {
    ...
    private fun getReports(date: String) {
        ...
        val body = FormBody.Builder()
                ...
                .add("Date", date)
                .add("Type", FieldForceTypes.COMPLETED)
                .build()

        Log.e("__________post", "_field_force_completed : ")
        ...
        callGetList?.enqueue(object : Callback {
            ...
            override fun onResponse(call: Call?, response: Response?) {
                ...
                Log.e("_____________resp", "_field_force_completed : $resp")
                try {
                    ...
                    Log.e("_______exc", "_field_force_completed : " + e.message)
                    runOnUiThread {
                        rvList.visibility = View.GONE
                        ivMap.visibility = View.GONE
                        tvMessage.visibility = View.VISIBLE
    ...
    private fun showList(list: ArrayList<RvListModel>, date: String) {
        rvList.adapter = RvCompletedListAdapter(list, date)
