...
class RvInProgressListAdapter(var list: ArrayList<RvListModel>, val date: String) : RecyclerView.Adapter<RvInProgressListAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.item_rv_in_progress_list, parent, false)
        return ViewHolder(v)
    }
