...
import com.teamayka.vansaleandmgmt.ui.salesreturn.adapters.SalesReturnBillRvAdapter
import com.teamayka.vansaleandmgmt.utils.RvItemMargin

class SalesReturnBillActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fabFinish.setOnClickListener {
            val intent = Intent(this, SalesReturnFinishActivity::class.java)
