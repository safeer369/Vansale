...
class PurchaseBillRvAdapter(private val list: ArrayList<ProductModel>) : RecyclerView.Adapter<PurchaseBillRvAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.item_rv_purchase_bill, parent, false)
        return ViewHolder(v)
    }
