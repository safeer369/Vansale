...
import com.teamayka.vansaleandmgmt.ui.sales.adapters.SalesBillRvAdapter
...
class SalesBillActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rvBill.adapter = SalesBillRvAdapter(list)
        ...
        fabFinish.setOnClickListener {
            val intent = Intent(this, SalesFinishActivity::class.java)
