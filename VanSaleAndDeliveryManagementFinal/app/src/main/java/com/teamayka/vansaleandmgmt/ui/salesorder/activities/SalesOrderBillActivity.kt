...
import com.teamayka.vansaleandmgmt.ui.salesorder.adapters.SalesOrderBillRvAdapter
import com.teamayka.vansaleandmgmt.utils.RvItemMargin

class SalesOrderBillActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fabFinish.setOnClickListener {
            val intent = Intent(this, SalesOrderFinishActivity::class.java)
